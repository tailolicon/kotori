...
class SourcePreferences(
    ...
    val animeExtensionRepos: Preference<Set<String>> = preferenceStore.getStringSet(
        "anime_extension_repos",
        setOf("https://raw.githubusercontent.com/yuzono/anime-repo/repo"),
    )

    val stremioAddons: Preference<Set<String>> = preferenceStore.getStringSet(
        "stremio_addons",
        emptySet(),
    )
