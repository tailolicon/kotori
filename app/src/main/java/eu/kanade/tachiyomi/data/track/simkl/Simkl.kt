...
class Simkl(id: Long) : BaseTracker(id, "Simkl"), AnimeTracker {
    ...
    // Anime-only tracker: manga-side operations are unsupported.
    override fun getStatusList(): List<Long> = emptyList()

    override fun getStatus(status: Long): dev.icerock.moko.resources.StringResource? = null

    override fun getReadingStatus(): Long = 0L

    override fun getRereadingStatus(): Long = 0L

    override fun displayScore(track: tachiyomi.domain.track.model.Track): String = ""

    override suspend fun update(
        track: eu.kanade.tachiyomi.data.database.models.Track,
        didReadChapter: Boolean,
    ): eu.kanade.tachiyomi.data.database.models.Track = throw UnsupportedOperationException()
    ...
    override suspend fun search(
        query: String,
    ): List<eu.kanade.tachiyomi.data.track.model.TrackSearch> = emptyList()
